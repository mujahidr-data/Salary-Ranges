 ...
 * @changelog v4.19.0 - ENHANCEMENT: Suppress .5 level warnings (reduce noise)
 *   - IMPROVED: Column S no longer flags .5 levels as "No market data"
 *   - REASON: .5 levels (L5.5 IC, L6.5 Mgr) are ALWAYS synthetic/calculated
 *   - LOGIC: Ranges generated by averaging neighbors or 1.2× multiplier
 *   - IMPACT: Cleaner Column S - only shows real missing data issues
 *   - UPDATED: Both syncEmployeesMappedSheet_() and refreshMarketDataAvailability()
 *   - RESULT: ~40% reduction in false positive warnings (all .5 level employees)
 * @previous v4.18.0 - BUGFIX: Correct executive level mapping (E1/E3/E5/E6)
